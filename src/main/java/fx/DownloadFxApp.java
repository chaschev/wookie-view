...
public class DownloadFxApp extends Application {
    ...
    static void tryFind(final SimpleBrowser2 browser, String archiveUrl, final WhenDone whenDone) {
...
//                                                progressProp.set(progress);
    ...
    protected void tryArchiveLink(boolean found, String finalArchiveUrl, SimpleBrowser2 browser) {
