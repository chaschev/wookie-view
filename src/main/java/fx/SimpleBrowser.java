...
public class SimpleBrowser extends Pane {
    /*public static final Logger logger = LoggerFactory.getLogger(SimpleBrowser2.class);
    ...
    public static class Builder {
        ...
        public SimpleBrowser2 build() {
            return new SimpleBrowser2(this);
        }
    }
    ...
    public SimpleBrowser2 load(String location) {
    ...
    public SimpleBrowser2 load(final String location, final Runnable onLoad) {
